...
const Election = () => {
  ...
  const candidatesByPosition = candidatesData.reduce((acc, candidate) => {
          ...
          <div className="card-body">
            <h2 className="card-title text-2xl mb-6">
              ...
              <div className="badge badge-primary">
                {data?.data?.voteables[selectedPosition]?.length || 0}{" "}
                candidates
              </div>
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {data?.data?.voteables[selectedPosition]?.map((candidate) => (
                <div
                  ...
                  <div className="card-body">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="avatar placeholder">
                        <div className="bg-primary text-primary-content rounded-full p-4 text-center">
                      ...
                      <div>
                        <h3 className="card-title text-lg">{candidate.candidateName}</h3>
