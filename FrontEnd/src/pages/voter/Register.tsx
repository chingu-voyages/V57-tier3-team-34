...
import { useRegisterVoter } from "../../functions/registerVoter";

import PasswordInput from "../../components/PasswordInput";

const Register = () => {
  const { registerVoter, isLoading } = useRegisterVoter();
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center text-black w-4/5 lg:w-full my-20">
        ...
        >
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`bg-blue-700 items-end p-2 rounded text-white cursor-pointer mt-3 active:scale-95 transition-all ${
